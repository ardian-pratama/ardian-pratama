...
export const Route = createFileRoute('/(main)/blogs/')({ component: Blog })
    ...
    >
      ...
      >
        <div className="@max-4xl:text-center @4xl:col-span-2 @7xl:col-span-2">
          <h1 className="@4xl:text-left">Muara Pemikiran</h1>
          <p className="mt-4">
            Tulisan adalah wadah bagi ide dan rasa ingin tahu, tempat di mana
            pikiran tersusun dan menemukan bentuknya melalui kata demi kata.
          </p>
          <div
        ...
        >
          <div className="mt-4 flex items-center gap-2 @4xl:mt-0 @7xl:col-span-1 @7xl:col-start-2">
            ...
            <DropdownMenu>
              ...
              >
                <Link to="/blogs" activeOptions={{ exact: true }}>
                  {({ isActive }) => {
                    return (
                      <Button
                        variant={isActive ? 'secondary' : 'ghost'}
